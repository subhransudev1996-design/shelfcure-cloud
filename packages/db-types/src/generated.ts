...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      rpc_report_overall_performance: {
        Args: { p_store_id: string; p_period_type?: string }
        Returns: Json
      }
      rpc_report_profit_tracking: {
        Args: { p_store_id: string; p_from: string; p_to: string }
        Returns: Json
      }
      ...
      rpc_report_growth_trend: {
        Args: { p_store_id: string; p_period_type?: string }
        Returns: Json
      }
      rpc_report_stock_movement: {
        Args: { p_store_id: string; p_from: string; p_to: string }
        Returns: Json
      }
      rpc_report_stock_velocity: {
        Args: { p_store_id: string; p_window_days?: number }
        Returns: Json
      }

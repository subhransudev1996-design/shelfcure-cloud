-- ShelfCure Cloud — Migration 0023
-- POS Phase A: rpc_pos_search_medicines now returns purchase_rate per batch so
-- the POS screen can compute Bill Profit (revenue − cost) live.

-- Postgres requires DROP when changing the return-table signature.

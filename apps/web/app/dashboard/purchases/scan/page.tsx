...
import { listDosageForms, listCategories } from '@shelfcure/api-client';
...
export default async function ScanBillPage() {
  ...
  const [{ data: storeRow }, { data: suppliers }, dosageForms, categories] = await Promise.all([
    ...
    listCategories(supabase, activeStoreId),
  ]);

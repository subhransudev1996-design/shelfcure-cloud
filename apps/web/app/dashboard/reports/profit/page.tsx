    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-zinc-200 py-24">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-green-50">
          <svg viewBox="0 0 24 24" fill="none" className="h-8 w-8 text-green-400"><path d="M3 17l4-8 4 4 4-6 4 4" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" /></svg>
        </div>
        <h2 className="mt-4 text-lg font-bold text-zinc-800">Profit Tracking — Coming Soon</h2>
        <p className="mt-2 max-w-sm text-center text-sm text-zinc-500">P&L breakdown, daily profit trend, top earners, margin analysis and loss-maker identification.</p>

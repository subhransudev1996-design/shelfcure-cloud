import { listStores } from '@shelfcure/api-client';
    ...
    <>
      ...
      {!stores.length ? (
        <EmptyState
          ...
          title="No stores yet"
          description="Add your first store to start managing medicines, customers, and sales."
          action={<AddStoreButton />}
        />
      ) : (
